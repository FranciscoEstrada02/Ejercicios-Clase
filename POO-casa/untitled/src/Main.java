...
public class Main {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < numEspectadores && cine.haySitio(); i++) {
            ...
            e = new Espectador(
                    Metodos.nombres[Metodos.generarNumeroAleatorio(0, Metodos.nombres.length - 1)], //Nombre al azar
                    Metodos.generarNumeroAleatorio(10, 30), //Generamos una edad entre 10 y 30
                    Metodos.generarNumeroAleatorio(1, 10)); //Generamos el dinero entre 1 y 10 euros
            ...
            do {
                ...
                fila = Metodos.generarNumeroAleatorio(0, cine.getFilas() - 1);
                letra = (char) Metodos.generarNumeroAleatorio('A', 'A' + (cine.getColumnas()-1));
